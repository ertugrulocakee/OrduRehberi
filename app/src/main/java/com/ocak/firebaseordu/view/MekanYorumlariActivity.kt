...
import com.ocak.firebaseordu.adapter.MekanYorumlariAdapter
                ...
                if(snapshot != null){
                    ...
                    if(snapshot.isEmpty == false){
                        ...
                        for ( document in documents){
                            ...
                            val indirilen = MekanYorumlari(kullaniciAdi,kullaniciYorum,puan,mekanDokumanId,mekanYorumId,kullanici)
