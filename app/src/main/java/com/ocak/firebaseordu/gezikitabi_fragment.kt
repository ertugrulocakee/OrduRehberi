...
import kotlinx.android.synthetic.main.fragment_gezikitabi_fragment.*


class gezikitabi_fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_gezikitabi_fragment, container, false)
    }
    ...
    companion object {
        fun newInstance(): gezikitabi_fragment {

            val fragment = gezikitabi_fragment()
    ...
    fun verileriAl(){
        ...
        activity?.let {
            ...
            database.collection("Post").whereEqualTo("deneyimTuru","Gezi Kitabı").orderBy("tarih", Query.Direction.DESCENDING).addSnapshotListener { snapshot, exception ->
                if(exception !=null){
