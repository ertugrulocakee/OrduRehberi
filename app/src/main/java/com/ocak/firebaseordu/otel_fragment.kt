...
class otel_fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_otel_fragment, container, false)
    }
    ...
    companion object {
        fun newInstance(): otel_fragment {

            val fragment = otel_fragment()
    ...
    fun verileriAl(){
        ...
        activity?.let {
            ...
            database.collection("Post").whereEqualTo("deneyimTuru","Otel").orderBy("tarih", Query.Direction.DESCENDING).addSnapshotListener { snapshot, exception ->
                if(exception !=null){
