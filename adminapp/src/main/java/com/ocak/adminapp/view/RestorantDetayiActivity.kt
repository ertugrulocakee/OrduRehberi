                ...
                override fun onLocationResult(locationResult: LocationResult) {
                    ...
                    if (locationResult !=null && locationResult.locations.size > 0){
                        ...
                        builder.setPositiveButton(
                            ...
                            Toast.makeText(this@RestorantDetayiActivity, "Rota başarıyla oluşturuldu",Toast.LENGTH_SHORT).show()
        ...
        if (restorantYorumu.isEmpty() == false && restorantPuani.isEmpty() == false ){
            ...
            database.collection("Restorantlar").document(restorantId).collection("RestorantYorumlari").add(postHashMap).addOnCompleteListener {
                ...
                if (it.isSuccessful){
                    ...
                    Toast.makeText(this,"Restorant hakkındaki yorumunuz başarıyla paylaşıldı.",Toast.LENGTH_SHORT).show()
