...
class istasyon_fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_istasyon_fragment, container, false)
    }
    ...
    companion object {
        fun newInstance(): istasyon_fragment {

            val fragment = istasyon_fragment()
    ...
    fun verileriAl(){
        ...
        activity?.let {
            ...
            database.collection("Post").whereEqualTo("deneyimTuru","İstasyon").orderBy("tarih", Query.Direction.DESCENDING).addSnapshotListener { snapshot, exception ->
                if(exception !=null){
